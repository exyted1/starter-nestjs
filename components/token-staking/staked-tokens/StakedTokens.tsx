...
export const StakedTokens = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex flex-row-reverse flex-wrap aloha gap-5 aloha">
        <div className="flex flex-wrap gap-5">
          <Tooltip title={'Unstake will automatically claim reward for you.'}>
            <button
              ...
              className="my-auto flex items-center justify-center rounded-md px-2.5 py-2 hover:scale-[1]"
            >
          ...
          <Tooltip title="Attempt to unstake all tokens at once">
            <button
              ...
              className="my-auto flex cursor-pointer rounded-md px-2.5 py-2 hover:scale-[1]"
            >
          ...
          {rewardDistributorData.data &&
            rewards.data?.claimableRewards.gt(new BN(0)) && (
              <button
                ...
                className="custom-button-container my-auto flex items-center justify-center rounded-md px-4 py-2 hover:scale-[1.03]"
              >
                <span className="mr-1 inline-block custom-class-for-spinner">
...
<span className="my-auto custom-class-for-claim-rewards">
