...
export const QuickActions = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute top-2 right-2 z-50 flex h-5 w-5 cursor-pointer items-center justify-center rounded-md text-xs`}
        style={{
          transition: '0.2s all',
          background:
            trySeq(() =>
              lighten(0.07, stakePoolMetadata?.colors?.backgroundSecondary || '#000')
            ) ?? '',
        }}
        key={
