...
import { Slider } from '../../components/hero-stats/Slider'
    ...
    return (
      ...
      >
        ...
        <div className="flex grow items-center justify-center">
          <div className="w-[1500px] max-w-[95vw] rounded-xl bg-black bg-opacity-50 p-10 text-center">
  ...
  return (
    <div
      ...
      >
        ...
        <HeroLarge />
        <AttributeAnalytics />
        <div className="flex justify-center imagine2">
          <TabSelector<PANE_OPTIONS>
            colors={{
              background: stakePoolMetadata?.colors?.secondary,
              color: stakePoolMetadata?.colors?.backgroundSecondary,
            }}
      ...
      {!stakePoolMetadata?.hideFooter ? (
        <Footer bgColor={tryColor(stakePoolMetadata?.colors?.backgroundSecondary)} />
      ) : (
